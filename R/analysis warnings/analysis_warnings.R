...
appFinal_before_after = merge(appFinal_before_after,
                              score %>% select(MRUN, promedio_cm_actual,  promedio_lm_anterior, pace, bea, percentil_cm_actual, percentil_lm_anterior, clec_actual, mate_actual, cien_actual, hcso_actual),
                              by = "MRUN", all.x = TRUE)
...
#Create dummy pace/bea applicants
...
ITT_1_safety = lm(data = appFinal_before_after %>% subset(Treatment_3 != 1 & Strata_2_label=="Safety"), formula = changed_app_after ~ Treatment_01)
summary(ITT_1_safety)
ITT_1 = lm(data = appFinal_before_after %>% subset(Treatment_3 != 1), formula = changed_app_after ~ Treatment_0 + Treatment_1)
summary(ITT_1)
ITT_1 = lm(data = appFinal_before_after %>% subset(Treatment_3 != 1 & Strata_2_label=="Safety"), formula = app_length_change ~ Treatment_01)
summary(ITT_1)
ITT_2 = lm(data = appFinal_before_after %>% subset(Treatment_3 != 1), formula = app_length_change ~ Treatment_0 + Treatment_1)
summary(ITT_2)
ITT_3 = lm(data = appFinal_before_after %>% subset(Treatment_3 != 1 & Strata_2_label=="Safety"), formula = nber_progr_added ~ Treatment_0 + Treatment_1)
summary(ITT_3)
...
ITT_1 = lm(data = appFinal_before_after %>% subset(Treatment_3 != 1 & Strata_2_label=="Safety"), formula = app_length_change ~ Treatment_01)
summary(ITT_1)
ITT_6 = lm(data = appFinal_before_after %>% subset(Treatment_3 != 1 & error_before==1), formula = error_after ~ Treatment_01)
summary(ITT_6)
ITT_6 = lm(data = appFinal_before_after %>% subset(Treatment_3 != 1 & error_before==1), formula = error_after ~ Treatment_0 + Treatment_1)
summary(ITT_6)
ITT_7_safety = lm(data = appFinal_before_after %>% subset(Treatment_3 != 1 & asignado_before==0  & Strata_2_label=="Safety"), formula = asignado ~ Treatment_01)
summary(ITT_7_safety)
ITT_7 = lm(data = appFinal_before_after %>% subset(Treatment_3 != 1 & asignado_before==0), formula = asignado ~ Treatment_01)
summary(ITT_7)
ITT_7 = lm(data = appFinal_before_after %>% subset(Treatment_3 != 1 & asignado_before==0), formula = asignado ~ Treatment_0 + Treatment_1)
summary(ITT_7)
ITT_8_safety = lm(data = appFinal_before_after %>% subset(Treatment_3 != 1 & asignado_before==1 & Strata_2_label=="Safety"), formula = program_asig_change ~ Treatment_01)
summary(ITT_8_safety)
ITT_8 = lm(data = appFinal_before_after %>% subset(Treatment_3 != 1 & asignado_before==1), formula = program_asig_change ~ Treatment_01)
summary(ITT_8)
...
library(ivreg)
firststage =lm(data = appFinal_before_after %>% subset(Treatment_3 != 1), formula = abrio_cartilla ~ Treatment_01)
summary(firststage)

ATE_7 = ivreg(data = appFinal_before_after %>% subset(Treatment_3 != 1), formula = changed_app_after ~ abrio_cartilla | Treatment_01)
summary(ATE_7)

ATE_7 = ivreg(data = appFinal_before_after %>% subset(Treatment_3 != 1 & asignado_before==0), formula = asignado ~ abrio_cartilla | Treatment_01)
summary(ATE_7)

ATE_8 = ivreg(data = appFinal_before_after %>% subset(Treatment_3 != 1 & asignado_before==1), formula = program_asig_change ~ abrio_cartilla | Treatment_01)
summary(ATE_8)
...
stargazer(ITT_1_safety, ITT_7_safety, title="Intention-to-Treat",
          dep.var.labels=c("Change ROL", "Assigned Ex-Post"),
          covariate.labels=c("T0", "T1"),
          omit.stat=c("LL","ser","f"), single.row=FALSE)
...
ITT_1_reducedrisk_strata = lm(data = appFinal_before_after %>% subset((Treatment_0==1 | Treatment_1==1 | Treatment_2==1) &  Strata_2_label=="Safety"), formula = reduced_risk ~ Treatment_01)
summary(ITT_1_reducedrisk_strata)
ITT_2_reducedrisk_strata = lm(data = appFinal_before_after %>% subset((Treatment_0==1 | Treatment_1==1 | Treatment_2==1) &  Strata_2_label=="Reach"), formula = reduced_risk ~ Treatment_01)
summary(ITT_2_reducedrisk_strata)
ITT_1_changerisk_strata = lm(data = appFinal_before_after %>% subset((Treatment_0==1 | Treatment_1==1 | Treatment_2==1) &  Strata_2_label=="Safety"), formula = change_risk ~ Treatment_01)
summary(ITT_1_changerisk_strata)
ITT_2_changerisk_strata = lm(data = appFinal_before_after %>% subset((Treatment_0==1 | Treatment_1==1 | Treatment_2==1) &  Strata_2_label=="Reach"), formula = change_risk ~ Treatment_01)
summary(ITT_2_changerisk_strata)
...
balance2_within1 <- lm(data = appFinal_before_after %>% subset(Treatment_1==1 & propensity_score_sample==1), formula = asignado_before ~ abrio_cartilla )
summary(balance2_within1)
balance2_within1_anais <- lm(data = appFinal_before_after %>% subset(Treatment_1==1 & propensity_score_sample_anais==1), formula = asignado_before ~ abrio_cartilla )
summary(balance2_within1_anais)
...
within_increasedrisk1_strata = lm(data = appFinal_before_after %>% subset(propensity_score_sample==1 &  Treatment_01 == 1  & Strata_2_label=="Reach"), formula = increased_risk ~ abrio_cartilla)
summary(within_increasedrisk1_strata)
within_increasedrisk2_strata = lm(data = appFinal_before_after %>% subset(propensity_score_sample==1 &  Treatment_02 == 1 & Strata_2_label=="Reach"), formula = increased_risk ~ abrio_cartilla)
summary(within_increasedrisk2_strata)
within_increasedrisk3_strata = lm(data = appFinal_before_after %>% subset(propensity_score_sample==1 & Treatment_0 == 1   & Strata_2_label=="Reach"), formula = increased_risk ~ abrio_cartilla)
summary(within_increasedrisk3_strata)
...
within_reducedrisk1_strata = lm(data = appFinal_before_after %>% subset(propensity_score_sample==1 &  Treatment_01 == 1  & Strata_2_label=="Safety"), formula = reduced_risk ~ abrio_cartilla)
summary(within_reducedrisk1_strata)
within_reducedrisk2_strata = lm(data = appFinal_before_after %>% subset(propensity_score_sample==1 &  Treatment_02 == 1  & Strata_2_label=="Safety"), formula = reduced_risk ~ abrio_cartilla)
summary(within_reducedrisk2_strata)
within_reducedrisk3_strata = lm(data = appFinal_before_after %>% subset(propensity_score_sample==1 & Treatment_0 == 1  & Strata_2_label=="Safety"), formula = reduced_risk ~ abrio_cartilla)
summary(within_reducedrisk3_strata)
...
summary(within_changerisk1_strata)
within_changerisk2_strata = lm(data = appFinal_before_after %>% subset(propensity_score_sample==1 &  Treatment_02 == 1  & Strata_2_label=="Safety"), formula = change_risk ~ abrio_cartilla)
summary(within_changerisk2_strata)
within_changerisk3_strata = lm(data = appFinal_before_after %>% subset(propensity_score_sample==1 & Treatment_0 == 1  & Strata_2_label=="Safety"), formula = change_risk ~ abrio_cartilla)
summary(within_changerisk3_strata)
...
stargazer(within_1, within_error1, within_assign1, within_reducedrisk1_strata,  title="Within-Treatment",
          dep.var.labels=c("Changed ROL", "Removed App. Mistake", "Change Assignement Status", "Decreased Risk"),
          covariate.labels=c("Opened E-mail"),
          omit.stat=c("LL","ser","f"), single.row=FALSE)
